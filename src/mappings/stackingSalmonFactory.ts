...
import { LendingPoolInitialized } from "../types/StackingSalmonFactory/StackingSalmonFactory";
...
export function handleLendingPoolInitialized(
  ...
  if (stackingSalmonFactory === null) {
    stackingSalmonFactory = new StackingSalmonFactory(STACKINGSALMON_FACTORY_ADDRESS);
    stackingSalmonFactory.totalBalanceUSD = ZERO_BD;
    stackingSalmonFactory.totalSupplyUSD = ZERO_BD;
    stackingSalmonFactory.totalBorrowsUSD = ZERO_BD;
  }
