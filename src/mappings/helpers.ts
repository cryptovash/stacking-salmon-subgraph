...
import { ERC20 } from "../types/StackingSalmonFactory/ERC20";
import { ERC20SymbolBytes } from "../types/StackingSalmonFactory/ERC20SymbolBytes";
import { ERC20NameBytes } from "../types/StackingSalmonFactory/ERC20NameBytes";
import { STACKINGSALMON_FACTORY_ADDRESS } from "./constants";
import {
  StackingSalmonFactory,
  Borrowable,
  Collateral,
  LendingPool,
  Token,
...
import { Pair as PairContract } from "../types/StackingSalmonFactory/Pair";
import { FarmingPool as FarmingPoolContract } from "../types/StackingSalmonFactory/FarmingPool";
import { Distributor as DistributorContract } from "../types/StackingSalmonFactory/Distributor";
import { Collateral as CollateralContract } from "../types/StackingSalmonFactory/Collateral";
import { Borrowable as BorrowableContract } from "../types/StackingSalmonFactory/Borrowable";
import { VaultToken as VaultTokenContract } from "../types/StackingSalmonFactory/VaultToken";
import {
...
export function updateLendingPoolUSD(pairAddress: String): void {
  ...
  let stackingSalmonFactory = StackingSalmonFactory.load(STACKINGSALMON_FACTORY_ADDRESS);
  if (stackingSalmonFactory === null) return;
  stackingSalmonFactory.totalBalanceUSD = stackingSalmonFactory.totalBalanceUSD
    .plus(lendingPool.totalBalanceUSD)
    .minus(prevTotalBalanceUSD);
  stackingSalmonFactory.totalSupplyUSD = stackingSalmonFactory.totalSupplyUSD
    .plus(lendingPool.totalSupplyUSD)
    .minus(prevTotalSupplyUSD);
  stackingSalmonFactory.totalBorrowsUSD = stackingSalmonFactory.totalBorrowsUSD
    .plus(lendingPool.totalBorrowsUSD)
    .minus(prevTotalBorrowsUSD);
  stackingSalmonFactory.save();
}
